...
var theTests = []struct {
	...
	{"cs", "/colonels-suite", "GET", http.StatusOK},
	{"sa", "/search-availability", "GET", http.StatusOK},
	{"contact", "/contact", "GET", http.StatusOK},

	// {"post-search-availability", "/search-availability", "POST", []postData{
	// 	{key: "start", value: "01-02-2023"},
	// 	{key: "end", value: "02-02-2023"},
	// }, http.StatusOK},
	...
	// 	{key: "first_name", value: "Darshan"},
	// 	{key: "last_name", value: "Heda"},
	// 	{key: "email", value: "darshanheda08@gmail.com"},
...
func TestRepository_Reservation(t *testing.T) {
	...
	//test cas where reservation is not in the context(reset everything)
	req, _ = http.NewRequest("GET", "/make-reservation", nil)
	ctx = getCtx(req)
	req = req.WithContext(ctx)
	rr = httptest.NewRecorder()
...
func TestRepository_PostAvailability(t *testing.T) {
	...
	*****************************************/
	...
	postedData = url.Values{}
	postedData.Add("start", "01-01-2040")
	postedData.Add("end", "02-01-2040")
	...
	*****************************************/
	...
	postedData = url.Values{}
	postedData.Add("start", "01-01-2060")
	postedData.Add("end", "02-01-2060")
	req, _ = http.NewRequest("POST", "/search-availability", strings.NewReader(postedData.Encode()))
...
func TestRepository_AvailabilityJSON(t *testing.T) {
	...
	//Second Case -- No rooms AVailable
	// create our request body
	reqBody = "start=01-01-2040"
	reqBody = fmt.Sprintf("%s&%s", reqBody, "end=02-01-2040")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "room_id=1")
	...
	reqBody = fmt.Sprintf("%s&%s", reqBody, "end=02-01-2060")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "room_id=1")
	req, _ = http.NewRequest("POST", "/search-availability-json", strings.NewReader(reqBody))
